...
router.post('/register', validateSchema(registerSchema), register) // Creando una nueva ruta POST para registrar un usuario
router.post('/login', validateSchema(loginSchema), login) // Creando una nueva ruta POST para iniciar sesión
